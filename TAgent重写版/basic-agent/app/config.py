...
# 答疑论文模式的「出题」：只出一道题，输出很短，一轮足够，名额与逐句批注同量级
ESSAY_TOPIC_LLM_TIMEOUT = 45
ESSAY_TOPIC_LLM_BUDGET = 70
ESSAY_TOPIC_MIN_ATTEMPT_TIMEOUT = 20
# 建议篇幅夹在这个区间：方案文档定的就是 500~2000 字的小作文。模型给的数只是建议，
